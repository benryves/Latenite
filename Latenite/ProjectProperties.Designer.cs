namespace Latenite {
	partial class ProjectProperties {
		...
		private void InitializeComponent() {
			...
			this.BuildScripts.HideSelection = false;
			...
			this.ChooseHelpFiles.HideSelection = false;
			...
			this.TabIcons.TransparentColor = System.Drawing.Color.Empty;
			this.TabIcons.Images.SetKeyName(0, "textfield_rename.png");
			this.TabIcons.Images.SetKeyName(1, "brick.png");
			this.TabIcons.Images.SetKeyName(2, "help.png");
			// 
			// tableLayoutPanel3
			// 
